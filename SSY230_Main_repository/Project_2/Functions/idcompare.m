...
% Prediction subplot
subplot(2,1,1)
plot(t,z(:,1)) % Plot meassured y
hold on
plot(t,y_pred); % Plot predicted y
...
title('Prediction')
legend('Meassured', 'Predicted','','', 'Uncertainty','Location', 'Best')
hold off
...
hold off
title('Simulation')
legend('Meassured', 'Simulated','','','Uncertainty','Location', 'Best')
